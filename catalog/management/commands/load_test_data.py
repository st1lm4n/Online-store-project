...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Создание категорий
        category1 = Category.objects.create(name='Тестовая категория 1', description='Описание 1')
        category2 = Category.objects.create(name='Тестовая категория 2', description='Описание 2')
